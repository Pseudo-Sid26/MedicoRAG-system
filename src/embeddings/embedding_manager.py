...
#                 context_text = []
#                 if context.get('contains_diagnosis'):
#                     context_text.append("diagnosis")
#                 if context.get('contains_treatment'):
#                     context_text.append("treatment")
#                 if context.get('contains_symptoms'):
#                     context_text.append("symptoms")
#                 if context.get('contains_procedures'):
#                     context_text.append("procedures")
#
#                 if context_text:
#                     content = f"Medical context: {', '.join(context_text)}. {content}"
#
#             # Add section information
#             if chunk.get('section') and chunk['section'] != 'Unknown':
#                 content = f"Section: {chunk['section']}. {content}"
#
...
#             enhanced_query = f"Medical diagnosis: {query}"
#         elif query_type == "treatment":
#             enhanced_query = f"Medical treatment: {query}"
#         elif query_type == "symptoms":
#             enhanced_query = f"Medical symptoms: {query}"
#         elif query_type == "drug_interaction":
#             enhanced_query = f"Drug interaction: {query}"
#         elif query_type == "guidelines":
#             enhanced_query = f"Clinical guidelines: {query}"
#
